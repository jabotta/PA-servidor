...
public class Main {
    ...
    public static void main(String args[]) {
        ...
        ManejadorCategorias MC = ManejadorCategorias.getInstance(entityManager);
...
//        ManejadorUsuarios.getInstance().agregarUsuario(c4);
        ...
        /* Categorias */
        MC.agregarCategoria(new Categoria("Celulares", null));
        MC.agregarCategoria(new Categoria("Sistemas Operativos", MC.getCategoria("Celulares")));
        MC.agregarCategoria(new Categoria("iOS", MC.getCategoria("Sistemas Operativos")));
        MC.agregarCategoria(new Categoria("Android", MC.getCategoria("Sistemas Operativos")));
        MC.agregarCategoria(new Categoria("Windows Phone", MC.getCategoria("Sistemas Operativos")));
        MC.agregarCategoria(new Categoria("Symbian", MC.getCategoria("Sistemas Operativos")));
        MC.agregarCategoria(new Categoria("Blackberry OS", MC.getCategoria("Sistemas Operativos")));
        MC.agregarCategoria(new Categoria("Equipos", MC.getCategoria("Celulares")));
        MC.agregarCategoria(new Categoria("iPhone", MC.getCategoria("Equipos")));
        MC.agregarCategoria(new Categoria("Nexus", MC.getCategoria("Equipos")));
        MC.agregarCategoria(new Categoria("Samsung", MC.getCategoria("Equipos")));
        MC.agregarCategoria(new Categoria("Galaxy S3", MC.getCategoria("Samsung")));
        MC.agregarCategoria(new Categoria("Galaxy S4", MC.getCategoria("Samsung")));
        MC.agregarCategoria(new Categoria("Galaxy Ace", MC.getCategoria("Samsung")));
        MC.agregarCategoria(new Categoria("Blackberry", MC.getCategoria("Equipos")));
        MC.agregarCategoria(new Categoria("Nokia", MC.getCategoria("Equipos")));
        MC.agregarCategoria(new Categoria("Accesorios", MC.getCategoria("Celulares")));
        MC.agregarCategoria(new Categoria("Protectores", MC.getCategoria("Accesorios")));
        MC.agregarCategoria(new Categoria("Baterías", MC.getCategoria("Accesorios")));
        MC.agregarCategoria(new Categoria("Apple", null));
        MC.agregarCategoria(new Categoria("Videojuegos", null));
        MC.agregarCategoria(new Categoria("Playstation", MC.getCategoria("Videojuegos")));
        MC.agregarCategoria(new Categoria("Xbox", MC.getCategoria("Videojuegos")));
...
//
//        /////////////////Producto 1
//        cat1.put ("iPhone",MC.getCategoria("iPhone"));
//        cat1.put ("iOS",MC.getCategoria("iOS"));
//        cat1.put ("Apple",MC.getCategoria("Apple"));
...
//
//        /////////////////Producto 3
//        cat1.put ("Android",MC.getCategoria("Android"));
//        cat1.put ("Nexus",MC.getCategoria("Nexus"));
...
//        /////////////////Producto 4
//        cat1.put ("Android",MC.getCategoria("Android"));
//        cat1.put ("Galaxy S3",MC.getCategoria("Galaxy S3"));
...
//        /////////////////Producto 5
//        cat1.put ("Android",MC.getCategoria("Android"));
//        cat1.put ("Galaxy S4",MC.getCategoria("Galaxy S4"));
...
//        /////////////////Producto 6
//        cat1.put ("Android",MC.getCategoria("Android"));
//        cat1.put ("Galaxy Ace",MC.getCategoria("Galaxy Ace"));
...
//
//        /////////////////Producto 7
//        cat1.put ("Protectores",MC.getCategoria("Protectores"));
...
//
//        /////////////////Producto 11
//        cat1.put ("Xbox",MC.getCategoria("Xbox"));
...
//
//        /////////////////Producto 13
//        cat1.put ("Playstation",MC.getCategoria("Playstation"));
...
//
//        DataCategoria padre = new DataCategoria(MC.getCategoria("cat1"), true);
